require.def(['station2'],
  function(Station) {
    /**
     * Constructor.
     *
     * @param topologyText the multi-line text that describes the stations' topology.
     * @param stations an array of stations.
     * @returns an object representing the topology.
     */
    return function (topologyText, stations) {
      var gridWidth;
      var gridHeight;
      var grid;
